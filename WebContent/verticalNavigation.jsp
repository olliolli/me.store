...
<link href="css/verticalNavigation.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<ul id="qm0" class="qmmc">

		<li>
			<a class="qmparent" href="javascript:void(0)">Bücher</a>
			<ul>
				<li><a href="List?med=book&cat=thriller">Thriller</a></li>
				<li><a class="qmparent" href="javascript:void(0)">Kochen</a>
					<ul>
						<li><a href="javascript:void(0)">Vegetarisch</a></li>
						<li><a href="javascript:void(0)">Däftig</a></li>
						<li><a href="javascript:void(0)">Desserts</a></li>
						<li><a href="javascript:void(0)">Glutenfrei</a></li>
					</ul>
				</li>
				<li><a href="List?med=book&cat=action">Action</a></li>
				<li><a href="List?med=book&cat=abenteuer">Abenteuer</a></li>
				<li><a href="List?med=book&cat=märchen">Märchen</a></li>
			</ul>
		</li>

		<li><a class="qmparent" href="javascript:void(0)">Filme</a>
			<ul>
				<li><a href="javascript:void(0)">Disney</a></li>
				<li><a href="javascript:void(0)">Kinder</a></li>
				<li><a href="javascript:void(0)">Action</a></li>
				<li><a href="javascript:void(0)">Horror</a></li>
				<li><a href="javascript:void(0)">Doku</a></li>
			</ul>
		</li>

		<li><a class="qmparent" href="javascript:void(0)">Spiele</a>
			<ul>
				<li><a href="javascript:void(0)">Gesellschaft</a></li>
				<li><a href="javascript:void(0)">Kinder</a></li>
				<li><a href="javascript:void(0)">Spaß</a></li>
			</ul>
